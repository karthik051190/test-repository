...
export class CognitoUtil {
    ...
    public static _IDENTITY_POOL_ID = environment.identityPoolId; // 'us-east-1:0a19b2b2-1038-42b0-bf1f-d1bb78e3d299' // environment.identityPoolId;
    public static _USER_POOL_ID = environment.userPoolId; // 'us-east-1_XNq70YsBR' //environment.userPoolId;
    public static _CLIENT_ID = environment.clientId; // '4d0a42615pptje8ltn5t84soek' // environment.clientId;
